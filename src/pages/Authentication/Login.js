...
import addresssLogo from "../../assets/images/logo/addressLogo03.png";
...
const Login = (props) => {
  ...
  document.title = "SignIn | Issue Tracker - Admin & Dashboard ";
  return (
                ...
                <div className="text-center mt-sm-3 mb-3 text-white-50 ">
                  <div>
                    <Link to="/" className="d-inline-block auth-logo">
                      <img src={addresssLogo} alt="" height="150" />
                    </Link>
                  </div>
                  <p className="mt-3 text-primary fs-15 fw-medium text-dark">
